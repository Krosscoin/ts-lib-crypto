...
export const MAIN_NET_CHAIN_ID = 78; // N
...
export type TKeyPair<T extends TBinaryIn = TBase58> = TPublicKey<T> &
  TPrivateKey<T>;
...
export interface IWavesCrypto<TDesiredOut extends TBinaryOut = TBase58> {
  ...
  //Random
  random<T extends keyof TRandomTypesMap>(
    count: number,
    type: T
  ): TRandomTypesMap[T];
